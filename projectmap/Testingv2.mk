...
Objects0=../codeliteworkspace/build-$(ConfigurationName)/__/projectmap/kill_wumpus_ani.cpp$(ObjectSuffix) ../codeliteworkspace/build-$(ConfigurationName)/__/projectmap/main.cpp$(ObjectSuffix) 
...
## Objects
##
../codeliteworkspace/build-$(ConfigurationName)/__/projectmap/kill_wumpus_ani.cpp$(ObjectSuffix): kill_wumpus_ani.cpp ../codeliteworkspace/build-$(ConfigurationName)/__/projectmap/kill_wumpus_ani.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/jvdk_/Documents/projectmap/kill_wumpus_ani.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/kill_wumpus_ani.cpp$(ObjectSuffix) $(IncludePath)
../codeliteworkspace/build-$(ConfigurationName)/__/projectmap/kill_wumpus_ani.cpp$(DependSuffix): kill_wumpus_ani.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT../codeliteworkspace/build-$(ConfigurationName)/__/projectmap/kill_wumpus_ani.cpp$(ObjectSuffix) -MF../codeliteworkspace/build-$(ConfigurationName)/__/projectmap/kill_wumpus_ani.cpp$(DependSuffix) -MM kill_wumpus_ani.cpp

../codeliteworkspace/build-$(ConfigurationName)/__/projectmap/kill_wumpus_ani.cpp$(PreprocessSuffix): kill_wumpus_ani.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) ../codeliteworkspace/build-$(ConfigurationName)/__/projectmap/kill_wumpus_ani.cpp$(PreprocessSuffix) kill_wumpus_ani.cpp
